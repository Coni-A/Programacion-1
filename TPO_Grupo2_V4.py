...
while opcion != 11:
    if opcion == 1:
        ...
        codigo_producto = validar_codigo(input("Ingrese el codigo de barras del producto: "))
        ...
        cantidad_disponible = validar_numero(input("Ingrese la cantidad de unidades de producto que va a ingresar: "))
